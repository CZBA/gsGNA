...
# 读取数据
Alkalinity <- vroom("Alkalinity_predictions.csv", delim = ",", col_names = TRUE)
Aridity <- vroom("Aridity_predictions.csv", delim = ",", col_names = TRUE)
Cold <- vroom("Cold_predictions.csv", delim = ",", col_names = TRUE)
